...
git clone https://github.com/meysamnoori015/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
...
if [ -z "$destination_dir" ]; then
 ...
 cd /var/www/html/
 wget -O wizwizpanel.zip https://github.com/meysamnoori015/wizwizxui-timebot/releases/download/7.5.3/wizwizpanel.zip
